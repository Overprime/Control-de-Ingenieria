...
$sql="SELECT codigo,CONCAT(u.nombres,' ',u.apellidos) AS FULLNAME,r.fecha_inicio,
(a.nombre)as NOMBREAREA,(ot_codigoot)as OT,(oth.nombre)as NOMOT,r.hora_inicio,
...
<td><?php echo $row[OT].'-'.$row[NOMOT]; ?></td>
...
as  horas_programadas,oth.ot,(oth.nombre)as NOMOT FROM  reporte_trabajo as r 
...
<td style="text-align: center"><label><?php echo $row[ot_codigoot].'-'.$row[NOMOT]; ?></label></td>
