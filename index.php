...
<link rel="shortcut icon" type="image/x-icon"
 href="/control-ingenieria/include/img/favicon.ico">

<title>Control del Área de Ingenieria</title>

<!-- Bootstrap core CSS -->
<link href="/control-ingenieria/include/css/bootstrap.min.css" rel="stylesheet">

<!-- Custom styles for this template -->
<link href="/control-ingenieria/include/css/jumbotron.css" rel="stylesheet">

<!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
<!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
<script src="/control-ingenieria/include/js/ie-emulation-modes-warning.js">
</script>

<!-- Placed at the end of the document so the pages load faster -->
<script src="/control-ingenieria/include/js/jquery.min.js"></script>
<script src="/control-ingenieria/include/js/bootstrap.min.js"></script>
<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
<script src="/control-ingenieria/include/js/ie10-viewport-bug-workaround.js">
...
<a class="navbar-brand text-success" href="/control-ingenieria/home">Oveprime Manufacturing</a>
</div>
...
<div class="jumbotron">
<div class="container">
<h1 class="text-success">Control de Área de Ingenieria</h1>
