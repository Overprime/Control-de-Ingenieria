<link rel="stylesheet" type="text/css" href="/control-ingenieria/include/css/bootstrap.min.css">
...
<?php 
$link= Conectarse();
$listado=mysql_query("SELECT u.idusuario,u.nombres,u.apellidos,u.usuario,
	u.idarea,a.nombre,u.tipo,codigo_area,DATE_FORMAT(u.fecha_creacion,'%d/%m/%Y') as fecha,contrasena
FROM usuario  as u INNER JOIN 
area as a ON u.idarea=a.codigo_area  WHERE 	u.estado='00' 
...
<option value="<?php echo $reg[tipo];  ?>">
<?php 
if ($reg[tipo]=='01' )
 {
 echo "ADMIN";
...
<option value="00">USUARIO</option>
