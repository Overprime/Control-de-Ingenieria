...
$CORRELATIVOCO=$IDCO+1;
$NUMEROCO="CO-".ceros($CORRELATIVOCO, 4);
?>

<div class="form-group">
<a id="modal-822096" href="#modal-container-822095" 
role="button" class="btn btn-info btn-block" data-toggle="modal">
<i class="glyphicon glyphicon-plus-sign"></i>
CREAR OT CODRISE</a>

<div class="modal fade" id="modal-container-822095" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
onchange="conMayusculas(this);"  value="<?php echo $NUMEROCO; ?>" READONLY >
</div>
<div class="form-group">
<label>NOMBRE</label>
...
<input type="hidden" value="CO" name="empresa">
</div>
